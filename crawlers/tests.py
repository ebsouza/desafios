...
from crawler import IdWallRedditExtractor


class IdWallRedditExtractorTest(unittest.TestCase):

    def setUp(self):
        self.base_url = "https://old.reddit.com/"
        self.html_page = open("test-assets/page.html", "r")
        self.extractor = IdWallRedditExtractor(self.base_url, self.html_page)
    ...
    def test_extract_parent_element_empty_page(self):
        extractor = IdWallRedditExtractor(self.base_url, "<html></html>")
